...
@Indexed
@Table(name="products")
public class EntityProductVariantHome {
	...
	private List<EntityProductVariantByUnitHome> productVariantsByUnit;
    
	@ManyToOne(cascade= 
	{CascadeType.DETACH, CascadeType.MERGE, CascadeType.PERSIST, CascadeType.REFRESH})
	@JoinColumn(name="product_brand_id")
	private EntityBrandVariantHome brand;
	...
	private List<EntityCategoryVariantHome> categories;
	...
	@ManyToMany(fetch=FetchType.EAGER, cascade= 
				{CascadeType.DETACH, CascadeType.MERGE,CascadeType.PERSIST, CascadeType.REFRESH}, 
				mappedBy="products")	
	private List<EntityTenantVariantHome> tenants;
	


	public EntityProductVariantHome() {
	...
	public String toString() {
		return "EntityProductVariantHome [productId=" + productId + ", bulkList=" + bulkList + ", productName="
				+ productName + ", gst=" + gst + ", productDeleteStatus=" + productDeleteStatus
				+ ", productActiveStatus=" + productActiveStatus + ", description=" + description + ", hasExpiryDate="
				...
				+ metaDescription + ", metaKeywords=" + metaKeywords + ", seoURL=" + seoURL + ", productVariantsByUnit="
				+ productVariantsByUnit + ", brand=" + brand + ", categories=" + categories + ", tenants=" + tenants
				+ "]";
	}



	public EntityProductVariantHome(Boolean bulkList, String productName, Integer gst, Boolean productDeleteStatus,
			...
			String seoURL, List<EntityProductVariantByUnitHome> productVariantsByUnit, EntityBrandVariantHome brand,
			List<EntityCategoryVariantHome> categories, List<EntityTenantVariantHome> tenants) {
		super();
